...
<h1 className='capitalize'>Collaborate with us</h1>
            ...
            <div className="text-white col-span-3 md:pt-5 md:col-span-2 md:flex items-start font-bold md:flex-col">
...
<button className='w-8/12 bg-white text-black flex justify-center items-center font-bold uppercase rounded my-9 p-4'>learn more <AiOutlineArrowRight className='ml-5 font-bold' /> </button>
            </div>
    </section>
  )
}
