...
<button className='w-8/12 bg-white text-black flex justify-center items-center font-bold uppercase rounded my-9 p-3'>learn more <AiOutlineArrowRight className='ml-5 font-bold' /> </button>
            </div>
    </section>
  )
}
