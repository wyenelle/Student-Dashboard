        ...
        <div className="col-span-1  relative">
          ...
          <div className=" w-full absolute top-8 bg-white/50 shadow-lg h-4/5 -left-40 flex items-center">
            <div className="w-11/12 ml-5 px-5 py-5 rounded shadow-lg bg-white prep">
                ...
                <p className="my-1">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Illo, nulla assumenda dolor quidem aliquam vitae sit est quo enim quasi temporibus, sed ipsa quibusdam eveniet.</p>

                <button className='bg-black text-white w-2/5 p-2 mt-3 font-bold rounded shadow-md flex justify-center gap-2 items-center '> Hire Our Grads
